...
class PassengerTicketViewSet(
    ...
    def get_serializer_class(self):
        ...
        if self.action in ["get_payment", "verify_payment"]:
        ...
        try:
            with transaction.atomic():
                ticket = Ticket.objects.create(
                    ...
                    + timedelta(
                        minutes=settings.TICKET_RESERVATION_MINUTES
                    ),
                )
    ...
    def initialize_payment(self, request, pk=None):
        ...
        return_url = (
            ...
            or "http://localhost:8080/payment-result"
        )
        ...
        payment, _ = Payment.objects.update_or_create(
            ...
            defaults={
                ...
                "tx_ref": tx_ref,
                "checkout_url": (
                    chapa_response.get("data", {})
                    .get("checkout_url")
                    or chapa_response.get("data", {})
                    .get("checkoutLink")
                    or ""
                ),
    ...
    def verify_payment(self, request, pk=None):
        ...
        try:
            verify_response = verify_chapa_payment(
                payment.tx_ref
            )
    ...
    def cancel_ticket(self, request, pk=None):
        ...
        serializer = TicketCancelSerializer(
            data=request.data
        )
